...
from build_model import init_he_normal, init_rai

# MNIST Example from PyTorch official examples
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        writer.add_scalars(
            "Training vs Test Loss", {"Training": train_loss, "Test": test_loss}, epoch
        )
        scheduler.step()
